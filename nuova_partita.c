...
void VisualizzaGrafica(int X,int Y)
{
int n,m;
...
// assegnazione dell'indirizzo delle coordinate
    ...
    controllox = scanf("%d",&x);
    getchar();
    
    if(controllox == 0) 
    printf("reinserisci la coordinata! \n");
    
}while( (controllox == 0) || (x<-1) || (x>10));
   ...
   int controlloy;
    ...
    controlloy = scanf("%d",&y);
    getchar();
    
    if(controlloy == 0) 
    printf("reinserisci la coordinata! \n");
    
}while( (controlloy == 0) || (y<-1) || (y>10));
