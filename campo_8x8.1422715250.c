...
void VisualizzaGrafica8x8(int X,int Y)
{
int n,m;
...
int StampaFeedbeek8x8(char var)
{
...
//stampa della grafica
    VisualizzaGrafica8x8( x, y);
// stampa punteggio x

    punt1 = StampaFeedbeek8x8('O');
    printf("Il punteggio di giocatore 1 e': %d ",punt1);
     punt2 = StampaFeedbeek8x8('X');
    printf("Il punteggio di giocatore 2 e': %d",punt2);
...
// assegnazione dell'indirizzo delle coordinate
    ...
    if(x == 9)
    {
         if((fp = fopen("SalvaPartita8.txt","w")) == NULL)
...
if (MAT[x-1][y-1] == ' ')   // controllo sulla posizione
{
	...
	//controllo posioxione adiacente
               ...
               {MAT[x-1][y-1] = var;
                ture++;}else{var = cambioTurno8x8();}




}else{var = cambioTurno8x8(); }
...
indicey=0;
     ...
     if(MAT[indicex][indicey] == 'X')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey-1] == 'O')
           {
              ...
              while((scorrix <8) && (scorriy<8) && (si==0) &&  (MAT[scorrix][scorriy] == 'X'))
              {
     ...
     if(MAT[indicex][indicey] == 'O')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey-1] == 'X')
           {
              ...
              while((scorrix <8) && (scorriy<8) && (si==0) &&  (MAT[scorrix][scorriy] == 'O'))
              {
...
indicey=0;
     ...
     if(MAT[indicex][indicey] == 'X')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey] == 'O')
           {
              ...
              while((scorrix <8) && (si==0) &&  (MAT[scorrix][scorriy] == 'X'))
              {
     ...
     if(MAT[indicex][indicey] == 'O')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey] == 'X')
           {
              ...
              while((scorrix <8 && (si==0)) &&  (MAT[scorrix][scorriy] == 'O'))
              {
...
indicey=0;
     ...
     if(MAT[indicex][indicey] == 'X')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey+1] == 'O')
           {
              ...
              while((scorrix <8) && (scorriy>0) && (si==0) &&  (MAT[scorrix][scorriy] == 'X'))
              {
                    if((MAT[scorrix+1][scorriy-1] == 'O'))
                    {si=1;}else{count++;}
                    scorrix++;
     ...
     if(MAT[indicex][indicey] == 'O')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex-1][indicey+1] == 'X')
           {
              ...
              while((scorrix <8) && (scorriy>0) && (si==0  &&  (MAT[scorrix][scorriy] == 'O')))
              {
                    if((MAT[scorrix+1][scorriy-1] == 'X'))
                    {si=1;}else{count++;}
                    scorrix++;
...
indicey=0;
     ...
     if(MAT[indicex][indicey] == 'X')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex][indicey-1] == 'O')
           {
              ...
              while((si==0) && (scorriy<8) &&  (MAT[scorrix][scorriy] == 'X') )
              {
     ...
     if(MAT[indicex][indicey] == 'O')  //indicex ricerca una X su tutta la matrice, quando la trova incomicnia a fare tt i controlli(orrizontale, vertical, obliquo)
     {
           ...
           if(MAT[indicex][indicey-1] == 'X')
           {
              ...
              while((scorriy<8) && (si==0)  &&  (MAT[scorrix][scorriy] == 'O'))
              {
