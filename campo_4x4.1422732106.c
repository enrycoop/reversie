...
void Visualizza4x4(int X,int Y)
{
int n,m;
...
int StampaFeedback4x4(char var)
{
...
// stampa punteggio x
    ...
    punt1 = StampaFeedback4x4('O');
    printf("Il punteggio di giocatore 1 e': %d \n",punt1);
     punt2 = StampaFeedback4x4('X');
...
// assegnazione dell'indirizzo delle coordinate
    ...
    if(x == 9)
    {
         if((fp = fopen("SalvaPartita4.txt","w")) == NULL)
...
if (MAT[x-1][y-1] == ' ')   // controllo sulla posizione
{
	...
	//controllo posioxione adiacente
	            if((MAT[x-2][y-2] == 'X') || (MAT[x-2][y-1] == 'X') || (MAT[x-2][y] == 'X') || (MAT[x-1][y] == 'X') || (MAT[x][y] == 'X') || (MAT[x-2][y-1] == 'X') || (MAT[x][y-2] == 'X') || (MAT[x-1][y-2] == 'X') || (MAT[x-2][y-2] == 'O') || (MAT[x-2][y-1] == 'O') || (MAT[x-2][y] == 'O') || (MAT[x-1][y] != 'O') || (MAT[x][y] != 'O') || (MAT[x-2][y-1] != 'O') || (MAT[x][y-2] != 'O') || (MAT[x-1][y-2] != 'O'))
                {MAT[x-1][y-1] = var;
                emptyspace++;}else{var = cambioTurno4x4();}




}else{var = cambioTurno4x4(); }
